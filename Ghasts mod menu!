...
namespace Ghastsmenu
{
    [BepInPlugin("org.jeydevv.monkeytag.Ghastsmenu", "Ghasts menu!", "1.3.1")]
    public class MyMenuPatcher : BaseUnityPlugin
    {
        public void Awake()
        {
            var harmony = new Harmony("com.jeydevv.monkeytag.GhastMenu");
